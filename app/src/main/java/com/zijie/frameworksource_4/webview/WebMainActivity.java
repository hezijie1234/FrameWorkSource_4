...
import com.zijie.xiangxuewebview.command.Command;
import com.zijie.xiangxuewebview.command.CommandsManager;
import com.zijie.xiangxuewebview.command.ResultBack;
import com.zijie.xiangxuewebview.remotewebview.BaseWebView;
import com.zijie.xiangxuewebview.utils.AidlError;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.openWeb1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WebActivity.startCommonWeb(WebMainActivity.this, "腾讯网", "https://xw.qq.com/?f=qqcom", WebConstants.LEVEL_BASE);
            }
        });
        ...
        findViewById(R.id.openWeb2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebActivity.startCommonWeb(WebMainActivity.this, "AIDL测试", BaseWebView.CONTENT_SCHEME + "aidl.html", WebConstants.LEVEL_ACCOUNT);
            }
        });
        ...
        findViewById(R.id.openWeb3).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                WebActivity.startAccountWeb(WebMainActivity.this, "百度", "http://www.baidu.com", WebConstants.LEVEL_ACCOUNT, accountInfo);
            }
        });
